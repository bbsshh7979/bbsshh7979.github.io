...
const serviceArea = '울산 · 경주 · 양산 · 김해 · 부산';
const orderedServiceArea = '울산·경주·양산·김해·부산';
document.querySelectorAll('meta[name="description"], meta[property="og:description"]').forEach((meta) => {
  meta.content = meta.content.replaceAll('울산·양산·부산·김해·밀양·경주', orderedServiceArea).replaceAll('울산·양산·부산·김해', orderedServiceArea);
});
...
if (pageHeading === '가까운지점') {
  ...
  if (branchHeroCopy) branchHeroCopy.textContent = '울산·양산 지점에서 만나보고, 경주·김해·부산까지 방문 시공합니다.';
}
if (pageHeading === '회사소개' || document.querySelector('.about-hero')) {
  const aboutCopy = document.querySelector('.detail-layout .detail-copy');
  if (aboutCopy) aboutCopy.textContent = '방충망완벽주의는 울산과 양산 3개 지점을 기반으로, 울산·경주·양산·김해·부산 지역의 방충망 교체와 제작, 수리와 시공을 진행합니다.';
}
if (document.querySelector('.home-hero')) {
  ...
  if (introCopy) introCopy.textContent = '울산과 양산 3개 지점을 기반으로 울산·경주·양산·김해·부산 지역의 방충망 수리와 제작, 시공을 진행합니다.';
}
document.querySelectorAll('.footer-brand small').forEach((copy) => {
  copy.innerHTML = '울산 · 경주 · 양산<br>김해 · 부산 출장시공';
});
...
if (headerInner && (!headerInner.querySelector('.nav-item') || !headerInner.querySelector('.header-links') || !headerInner.querySelector('.mobile-toggle'))) {
  ...
  headerLinks.innerHTML = '<a class="sns kakao" href="https://pf.kakao.com/_gxhgsn" target="_blank" rel="noreferrer" aria-label="카카오톡"><svg viewBox="0 0 32 28"><path d="M16 2C8.3 2 2 6.8 2 12.7c0 3.7 2.4 7 6.1 8.9L7 26l5.3-3.2c1.2.3 2.4.5 3.7.5 7.7 0 14-4.8 14-10.7S23.7 2 16 2Z"/><text x="7" y="17" textLength="18" lengthAdjust="spacingAndGlyphs">TALK</text></svg></a><a class="sns blog" href="https://blog.naver.com/perfect2025" target="_blank" rel="noreferrer" aria-label="네이버 블로그"><svg viewBox="0 0 32 28"><path d="M5 4h22a3 3 0 0 1 3 3v14a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><text x="4" y="17" textLength="24" lengthAdjust="spacingAndGlyphs">blog</text></svg></a><a class="sns instagram" href="https://www.instagram.com/perfect202524" target="_blank" rel="noreferrer" aria-label="인스타그램"><svg viewBox="0 0 28 28"><rect x="3" y="3" width="22" height="22" rx="6"/><circle cx="14" cy="14" r="5"/><circle cx="20" cy="8" r="1.2"/></svg></a><a class="call-link" href="tel:050714275919">상담전화</a>';
...
if (showcaseGrid) {
  ...
  showcaseGrid.innerHTML = `
    <article class="photo-story photo-story-large">
      <img src="work_6.jpg" alt="방충망 프레임을 제작하는 시공 모습">
    ...
    <article class="photo-story photo-story-medium">
      <img src="work_10.jpg" alt="창가에서 방충망을 점검하는 시공 모습">
    </article>
    <article class="photo-story photo-story-medium">
      <img src="work_9.jpg" alt="현관에서 방충망 프레임을 설치하는 시공 모습">
    </article>
    <article class="photo-story photo-story-text">
      <span>CARE / FINISH</span><h3>작은 틈까지<br>꼼꼼하게</h3><p>마지막 확인까지 책임지는 방충망완벽주의의 기준입니다.</p>
    </article>
    <article class="photo-story photo-story-wide">
      <img src="work_7.jpg" alt="창가에서 방충망을 시공하는 모습">
      <img src="work_8.jpg" alt="방충망 설치 후 현장을 확인하는 모습">
    </article>`;
}
...
if (entrancePhotos?.length === 2) {
  entrancePhotos[0].src = 'entrance_1.jpg';
  entrancePhotos[1].src = 'entrance_4.jpg';
}
...
if (sashRow) {
  ...
  if (emptyPhoto) {
    ...
    photoGroup.innerHTML = '<img src="sash_4.jpg" alt="샤시 제작 및 수리 작업"><img src="sash_1.jpg" alt="샤시 제작 및 수리 프레임">';
...
if (homeWorkGrid) {
  const workPhotos = [
    ['work_1.jpg', '정확한 실측과 제작'],
    ['work_2.jpg', '창호에 맞춘 꼼꼼한 시공'],
    ['work_3.jpg', '현장에서 완성하는 작업'],
    ['work_4.jpg', '안전하고 깔끔한 설치'],
    ['work_5.jpg', '마지막까지 꼼꼼한 마감']
  ];
    ...
    <footer>
      <div class="footer-inner">
        <div class="footer-brand">
          <img src="logo.jpg" alt="방충망완벽주의 로고">
          <strong>방충망완벽주의<small>울산 · 경주 · 양산<br>김해 · 부산 출장시공</small></strong>
        </div>
